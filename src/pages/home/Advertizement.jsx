...
const Advertizement = ({ showModel }) => {
  ...
  return (
    <dialog id="my_modal_5" open={showModel} className="modal rounded">
      <div className="modal-box w-11/12 max-w-4xl relative">
        ...
        <div className="modal-action absolute right-0 top-0">
          <form method="dialog">
            ...
            <button className="btn btn-circle hover:scale-105">❌</button>
          </form>
        </div>
      </div>
    </dialog>
